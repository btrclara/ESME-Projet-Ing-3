...
col_name = ['avg_ax','avg_ay','avg_az','avg_gx','avg_gy','avg_gz','avg_flex0','avg_flex1','avg_flex2','avg_flex3','avg_flex4','std_ax','std_ay','std_az','std_gx','std_gy','std_gz','std_flex0','std_flex1','std_flex2','std_flex3','std_flex4','mot']
...
resultats = dataset["mot"].value_counts()
print(resultats)
...
plt.show()
with open('model_pickle_BDD_Thomas6' , 'wb') as f :
 pickle.dump(model,f)
